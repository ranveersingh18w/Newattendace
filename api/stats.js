// Serverless function to get attendance stats
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/student/dashboard/attendance/stats`, {
            method: 'GET',
            headers: {
        ...
        if (!response.ok) {
            ...
            console.error('Stats fetch failed:', response.status, errorMessage);
